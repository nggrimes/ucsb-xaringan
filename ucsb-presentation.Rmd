...
# Draw on slides to help teach or highlight!

## Activate the scribble option in the extras chunk

`xaringanExtra::use_scribble()`

## [Try it out on this link](https://nggrimes.github.io/ucsb-xaringan/ucsb-scribble.html#1)

- Note: Scribble slightly slowed down the transitions in this presentations because of the number of slides and the fact that I've added A LOT of extra features

- Be aware of that lag

## Works great with touchscreens and laptop pens!
